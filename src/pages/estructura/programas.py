...
def render() -> None:
    report_template_without_filters(
        ...
        description="Programas Presupuestarios del INVICO. Utiliza el filtro avanzado para realizar consultas específicas.",
    ...
    try:
        df_programa = get_estructuras(filtro_actual)
        df_programa = df_programa[df_programa["estructura"].str.len() == 2]
